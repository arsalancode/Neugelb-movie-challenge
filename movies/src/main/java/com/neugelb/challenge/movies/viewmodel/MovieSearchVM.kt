...
import com.neugelb.challenge.BuildConfig.API_KEY
...
class MovieSearchVM(private val repo: com.neugelb.challenge.movies.networking.MovieSearchContract.Repo) : BaseVM() {
    ...
    /**
     * Handle the moviesNowPlaying returned from the API
     *
